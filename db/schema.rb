...
ActiveRecord::Schema.define(version: 20160928063353) do
  ...
  add_index "cart_commodities", ["cart_id"], name: "index_cart_commodities_on_cart_id"
  add_index "cart_commodities", ["commodity_id"], name: "index_cart_commodities_on_commodity_id"
